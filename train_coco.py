...
import torch
from dataset.COCO_dataset import COCODataset,Transforms
import math,time
...
train_dataset=COCODataset("./data/VLM_HD/data/train/img",
                          './data/VLM_HD/data/train/train.json',transform=transform)
# train_dataset=COCODataset("./data/MTH1200/train/img", "./data/MTH1200/train/train.json","./data/MTH1200/train/ostu", is_train=True)
